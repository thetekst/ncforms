...
<script type="text/javascript" src="http://www.google.com/recaptcha/api/challenge?k=[[+formitRecaptchaPK]]"></script>
<script type="text/javascript" src="http://www.google.com/recaptcha/api/js/recaptcha_canary.js"></script>
<noscript>
	<div>
        <object data="http://www.google.com/recaptcha/api/noscript?k=[[+formitRecaptchaPK]]" height="300" width="350" style="width: 350px; height: 300px;"></object>
